...
if TYPE_CHECKING:
    from codemonkeys.agents.python_changelog_writer import make_python_changelog_writer as make_python_changelog_writer
    ...
    from codemonkeys.agents.python_readme_reviewer import make_python_readme_reviewer as make_python_readme_reviewer
...
def __getattr__(name: str) -> object:
    ...
    if name == "make_python_changelog_writer":
        from codemonkeys.agents.python_changelog_writer import make_python_changelog_writer
        return make_python_changelog_writer
    ...
    if name == "make_python_readme_reviewer":
        from codemonkeys.agents.python_readme_reviewer import make_python_readme_reviewer
        return make_python_readme_reviewer
