...
resolver, and finishes with a final lint pass.
    ...
    lint → format → [test, code_review, security, docs, dep_audit]
...
Run with:
    ...
    python -m agentpipe.graphs.python_quality_gate /path/to/repo --mode full
    python -m agentpipe.graphs.python_quality_gate /path/to/repo --no-interactive
"""
